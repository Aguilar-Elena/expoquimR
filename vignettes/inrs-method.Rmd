...
```{r peligro}
# From H phrases
inrs_hazard_class(frases_h = "H336")
...
inrs_frequency_class(3, "horas")    # 3 hours/day → class 3
```
...
inrs_liquid_volatility_graph(temperatura_uso = 20, punto_ebullicion = 111)

# From vapour pressure (Table 8 thresholds: 0.5 kPa / 25 kPa)
inrs_liquid_volatility_pressure(presion_vapor = 5)
```
...
inrs_collective_protection("Condiciones moderadas de dispersion")
```
